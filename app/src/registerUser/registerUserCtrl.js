(function(){
  angular.module('registerUser')
         .controller('registerUserCtrl', ['$mdSidenav', '$mdDialog', '$mdBottomSheet', '$log', '$q','$scope', 'appUtils', 'homeService',
                                          RegisterUserCtrl
                                       ]);

  function RegisterUserCtrl($mdSidenav, $mdDialog , $mdBottomSheet, $log, $q, $scope, appUtils, homeService) {
    var self = this;
    self.states = "";
//    self.schoolPOJO = homeService.getSchoolPOJO();    
    self.load = function(){
    	$log.info("Inside load of RegisterUserCtrl >> "+self);
