       ...
       .module('starterApp')  
		  .config(
				  function($mdThemingProvider, $mdIconProvider, $stateProvider, $urlRouterProvider) {
                      ...
                      .icon("search_black"  , "./assets/icons/ic_search_black_24px.svg"        , 24)
                      ...
                      .icon("arrow_down"  , "./assets/icons/ic_arrow_drop_down_white_24px.svg "       , 24)
                      .icon("privacy_black"  , "./assets/icons/ic_settings_input_antenna_black_24px.svg "       , 24)
                      .icon("logout_black"  , "./assets/icons/ic_restore_black_24px.svg"       , 24)
                      .icon("delete_black"  , "./assets/icons/ic_delete_black_24px.svg"       , 24)
                      .icon("face_black"  , "./assets/icons/ic_face_black_24px.svg"       , 24)
                      .icon("toggle_black"  , "./assets/icons/ic_crop_free_black_24px.svg"       , 24)
                      .icon("arrow_up"  , "./assets/icons/ic_arrow_drop_up_white_24px.svg "       , 24)
                      .icon("add_black"  , "./assets/icons/ic_add_black_24px.svg "       , 24)
