  ...
  factory('$notification', ['$timeout',function($timeout){
    ...
    return {
      ...
      info: function(title, content, userData){
        ...
        return this.awesomeNotify('info','notifications', title, content, userData);
      },

      error: function(title, content, userData){
        return this.awesomeNotify('error', 'close', title, content, userData);
      },

      success: function(title, content, userData){
        return this.awesomeNotify('success', 'done', title, content, userData);
      },

      warning: function(title, content, userData){
        return this.awesomeNotify('warning', 'mood bad', title, content, userData);
      },
      ...
      '<div class="dr-notification-wrapper" ng-repeat="noti in queue">' +
        ...
        '<div class="dr-notification">' +
          '<div class="dr-notification-image dr-notification-type-{{noti.type}}" ng-switch on="noti.image">' +
            '<i class="material-icons" ng-switch-when="false">{{noti.icon}}</i>' +
